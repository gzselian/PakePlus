...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,0,967,785]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(5,1,1).p("AAzhWIABCtIhnhXg");
	this.shape.setTransform(-3.5409,0.4202,0.9827,1.1476,0,0,180);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgzAAIBmhWIABCtg");
	this.shape_1.setTransform(-3.5409,0.4202,0.9827,1.1476,0,0,180);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(5,1,1).p("ABAhWIAACtIh/hXg");
	this.shape_2.setTransform(6.9006,0.4202,0.9827,1.1476,0,0,180);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhAAAICAhWIABCtg");
	this.shape_3.setTransform(6.9006,0.4202,0.9827,1.1476,0,0,180);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3,p:{scaleY:1.1476,y:0.4202}},{t:this.shape_2,p:{scaleY:1.1476,y:0.4202}},{t:this.shape_1,p:{scaleY:1.1476,y:0.4202}},{t:this.shape,p:{scaleY:1.1476,y:0.4202}}]}).to({state:[{t:this.shape_10},{t:this.shape_4},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3,p:{scaleY:1.1475,y:0.4509}},{t:this.shape_2,p:{scaleY:1.1475,y:0.4509}},{t:this.shape_1,p:{scaleY:1.1475,y:0.4509}},{t:this.shape,p:{scaleY:1.1475,y:0.4509}}]},1).wait(2));
...
if (reversed == null) { reversed = false; }
	...
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {label1:1,label2:10,label3:19};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(9).call(this.frame_9).wait(9).call(this.frame_18).wait(9).call(this.frame_27).wait(1));

	// 图层_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(3,1,1).p("AoVznMAQrAnP");
	this.shape.setTransform(6.675,62.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FF0000").ss(3,1,1).p("AIKprIwTTX");
	this.shape_1.setTransform(7.375,-1.45);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FF0000").ss(3,1,1).p("AIDpsIwFTa");
	this.shape_2.setTransform(7.575,126.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape},{t:this.shape_1}]},9).to({state:[{t:this.shape},{t:this.shape_1},{t:this.shape_2}]},9).wait(9));

	// 图层_4
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(147.95,63.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("Ao8B1IAAjqIR5AAIAADqg");
	this.shape_4.setTransform(145.8283,191.55,1.2876,1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ao8B1IAAjqIR5AAIAADqg");
	this.shape_5.setTransform(138.7379,62.55,1.1596,1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ao8B1IAAjqIR5AAIAADqg");
	this.shape_6.setTransform(130.075,-64.55);

	this.instance = new lib.Bitmap1();
	this.instance.setTransform(-322,-229,0.6666,0.6666);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(28));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(-385.2,-384.9,771.8,1091.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		var _this = this;
		var showNum = 0;
		var timeArr = new Array(0,3.710,12.828,18.758,25.657,34.381,39.315,48.227,49.737);
	...
	this.shape_7.setTransform(412.2091,23.347,0.9827,1.1473,0,0,180);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgzAAIBmhWIABCtg");
	this.shape_8.setTransform(412.2091,23.347,0.9827,1.1473,0,0,180);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#FFFFFF").ss(5,1,1).p("ABAhWIAACtIh/hXg");
	this.shape_9.setTransform(422.6506,23.347,0.9827,1.1473,0,0,180);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhAAAICAhWIABCtg");
	this.shape_10.setTransform(422.6506,23.347,0.9827,1.1473,0,0,180);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_23.setTransform(46.325,46.175);
	...
	this._showbar.setTransform(640,308.7,0.9556,0.9556);
	...
	this.shape_25.graphics.f("rgba(255,255,255,0.8)").s().p("EhkVAEsIAApXMDIrAAAIAAJXg");
	this.shape_25.setTransform(639.9,690.4);
...
p.nominalBounds = rect = new cjs.Rectangle(637.7,367.2,1284.5,713.3);
p.frameBounds = [rect];
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1734485218764", id:"index_atlas_1"}
	],
	preloads: []
};
