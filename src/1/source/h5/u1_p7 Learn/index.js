...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,0,413,367],[0,369,413,276]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.2398,0.2397);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ClipGroup_44, rect = new cjs.Rectangle(0,0,99.1,66.2), [rect]);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AnsG1IAAgVIPZAAIAAAVgAnsjvIAAjFIPZAAIAADFg");
	mask.setTransform(49.55,43.975);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup_1_10, rect = new cjs.Rectangle(0.3,0.3,98.6,87.5), [rect]);
...
if (reversed == null) { reversed = false; }
	...
	// 图层_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#999999").s().p("EgnXAEiIAApDMBOvAAAIAAJDg");
	this.shape.setTransform(252,29);
...
p.nominalBounds = rect = null;
p.frameBounds = [rect, rect, rect, new cjs.Rectangle(0,0,504,58)];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-227.5,23.1,0.5952,1.1724,0,0,0,252,29.1);
	...
	// 图层_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("");
	this.shape.setTransform(-222.8246,24.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AUCCSQgFgDgDgFQgDgGAAgMQAAgRAGgEQAHgGAOABQAOgBAHAGQAGAEAAARQAAAMgDAGQgCAFgGADQgGABgKAAQgKAAgGgBgA0sCRIAAkjIAmAAIAAEjg");
	this.shape_1.setTransform(-227.5464,22.15);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("");
	this.shape_2.setTransform(-227.5464,24.85);
...
p.nominalBounds = rect = new cjs.Rectangle(-377.5,-11,300,68);
...
if (reversed == null) { reversed = false; }
	...
	// 图层_3
	this.instance = new lib.元件2();
	this.instance.setTransform(-2.95,5.1,1,1.1724,0,0,0,252,29);
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.元件2(), 3);
	...
	// 图层_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(89.025,9.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("");
	this.shape_1.setTransform(-9.9746,7.95);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("");
	this.shape_2.setTransform(0.525,7.95);
...
p.nominalBounds = rect = new cjs.Rectangle(-254.9,-32.2,504,71.4);
p.frameBounds = [rect, rect];
...
if (reversed == null) { reversed = false; }
	...
	this.mc2.name = "mc2";
	this.mc2.setTransform(574.3,352);

	this.mc1 = new lib.元件17();
	this.mc1.name = "mc1";
	this.mc1.setTransform(448.5,297.2);
	...
	this.instance.setTransform(897.6,360.1,4.8359,4.8359,0,0,0,49.6,33.1);

	this.instance_1 = new lib.ClipGroup_1_10();
	this.instance_1.setTransform(897.6,318.3,4.8359,4.8359,0,0,0,49.6,44.1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance_1},{t:this.instance},{t:this.pro_bar},{t:this.mc1},{t:this.mc2}]}).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1733295130221", id:"index_atlas_1"}
	],
	preloads: []
};
