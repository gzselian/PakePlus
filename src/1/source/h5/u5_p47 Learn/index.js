...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,0,285,215]]}
];
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AlUEBIAAoBIKpAAIAAIBg");
	mask.setTransform(34.1,25.7);

	// 图层_3
	this.instance = new lib.Image_36();
	this.instance.setTransform(0,0,0.2394,0.239);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup_91, rect = new cjs.Rectangle(0,0,68.2,51.4), [rect]);
...
if (reversed == null) { reversed = false; }
	...
	// 图层_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(3,1,1).p("A6ejWMA09AAAIAAGtMg09AAAg");
	this.shape.setTransform(169.475,21.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("A6eDXIAAmtMA09AAAIAAGtg");
	this.shape_1.setTransform(169.475,21.5);
...
p.nominalBounds = rect = null;
p.frameBounds = [rect, rect, rect, new cjs.Rectangle(-1.5,-1.5,342,46)];
...
(lib.ClipGroup_22_0 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(34.9,25.775);

	// 图层_3
	this.instance = new lib.ClipGroup_91();
	this.instance.setTransform(34.1,25.7,1,1,0,0,0,34.1,25.7);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup_22_0, rect = new cjs.Rectangle(2.7,0.3,64.5,51), [rect]);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(21,-2.3,1.0237,1.3721,0,0,0,169.5,21.6);
	...
	this.shape.setTransform(27.8775,-3.075,0.786,1);
	...
	this.shape_1.setTransform(12.6545,-3.075,0.8625,1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("");
	this.shape_2.setTransform(71.275,-1.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(5.55,-1.7237);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF0000").s().p("");
	this.shape_4.setTransform(18.675,-1.7237);
...
p.nominalBounds = rect = new cjs.Rectangle(-154.3,-33.7,350.6,62.6);
...
if (reversed == null) { reversed = false; }
	...
	// 图层_2
	this.instance = new lib.元件1();
	this.instance.setTransform(-155.05,16,1.2568,1,0,0,0,169.6,21.5);
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.元件1(), 3);
	...
	// 图层_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(-73.2208,15.1763);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("");
	this.shape_1.setTransform(-285.775,15.1763);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("");
	this.shape_2.setTransform(-156.5958,15.1763);
...
p.nominalBounds = rect = new cjs.Rectangle(-369.8,-15.3,429.4,58.3);
p.frameBounds = [rect, rect];
...
if (reversed == null) { reversed = false; }
	...
	// 图层_2
	this.instance = new lib.元件1();
	this.instance.setTransform(-74.45,-1.45,1,1,0,0,0,169.5,21.5);
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.元件1(), 3);
	...
	// 图层_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(-6.2708,-1.7237);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("");
	this.shape_1.setTransform(-174.325,-1.7237);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("");
	this.shape_2.setTransform(-75.5208,-1.7237);
...
p.nominalBounds = rect = new cjs.Rectangle(-245.4,-32.2,490.5,58.3);
p.frameBounds = [rect, new cjs.Rectangle(-245.4,-24.4,342,46)];
...
if (reversed == null) { reversed = false; }
	...
	// 图层 1
	this.instance = new lib.ClipGroup_22_0();
	this.instance.setTransform(666.5,345.5,2.9178,2.9178,0,0,0,34.1,25.8);
	...
	this.mc3.name = "mc3";
	this.mc3.setTransform(965.3,347.2);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("A6sEfIAAo9MA1ZAAAIAAI9g");
	this.shape.setTransform(984.8163,344.1143,1.044,1.2754);
	...
	this.shape_1.setTransform(805.7919,343.9583,0.9417,0.8834);

	this.mc2 = new lib.元件18();
	this.mc2.name = "mc2";
	this.mc2.setTransform(476.55,367.45);

	this.mc1 = new lib.元件17();
	this.mc1.name = "mc1";
	this.mc1.setTransform(350.75,312.65);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.pro_bar},{t:this.mc1},{t:this.mc2},{t:this.shape_1},{t:this.shape},{t:this.mc3}]}).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1733366459927", id:"index_atlas_1"}
	],
	preloads: []
};
