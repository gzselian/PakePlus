...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[1188,0,1160,902],[0,0,1186,926],[2350,0,1035,939]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3,p:{y:0.2664}},{t:this.shape_2,p:{y:0.2664}},{t:this.shape_1,p:{y:0.2664}},{t:this.shape,p:{y:0.2664}}]}).to({state:[{t:this.shape_10},{t:this.shape_4},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3,p:{y:0.2875}},{t:this.shape_2,p:{y:0.2875}},{t:this.shape_1,p:{y:0.2875}},{t:this.shape,p:{y:0.2875}}]},1).wait(2));
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AzSNVIAA6pMAmlAAAIAAapg");
	var mask_graphics_1 = new cjs.Graphics().p("AzSNVIAA6pMAmlAAAIAAapg");
	var mask_graphics_2 = new cjs.Graphics().p("AzSNVIAA6pMAmlAAAIAAapg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:121.45,y:102.125}).wait(1).to({graphics:mask_graphics_1,x:121.45,y:102.125}).wait(1).to({graphics:mask_graphics_2,x:121.45,y:102.125}).wait(1));
	...
	this.instance_1.setTransform(-7,-8,0.22,0.22);

	this.instance_2 = new lib._4();
	this.instance_2.setTransform(-3,-1,0.24,0.24);
	...
	// 图层_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#CCCCCC").ss(2,1,1).p("Azit+MAnFAAAIAAb9MgnFAAAg");
	this.shape.setTransform(121.45,102.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFAEB").ss(3,1,1).p("AzStUMAmlAAAIAAapMgmlAAAg");
	this.shape_1.setTransform(121.45,102.125);
...
p.nominalBounds = rect = new cjs.Rectangle(-4.6,11.7,252.1,181);
p.frameBounds = [rect, rect=new cjs.Rectangle(-3.5,15.3,250,173.6), rect];
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		var _this = this;
		var showNum = 0;
		var timeArr = new Array(0,6.250,18.832,29.695);
	...
	this.shape_7.setTransform(412.2091,23.3951,0.9827,1.1474,0,0,180);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgzAAIBmhWIABCtg");
	this.shape_8.setTransform(412.2091,23.3951,0.9827,1.1474,0,0,180);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#FFFFFF").ss(5,1,1).p("ABAhWIAACtIh/hXg");
	this.shape_9.setTransform(422.6506,23.3951,0.9827,1.1474,0,0,180);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhAAAICAhWIABCtg");
	this.shape_10.setTransform(422.6506,23.3951,0.9827,1.1474,0,0,180);
...
if (reversed == null) { reversed = false; }
	...
	// 图层_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("AgOCWQgOgFgHgIQgIgHgEgLIgEAfIg0AAIAAkvIA5AAIAAByQAGgNAQgIQAPgJAbAAQAjAAATAOQATANAGAZQAIAZgBAiQABAggIAYQgGAagTAOQgTAQgjAAQgTAAgNgEgAgegSQgLAIgEAPQgEAPAAAWQAAAVAEAPQAEAQALAHQALAJATAAQATAAALgKQAJgIADgQQADgPAAgTQAAgUgDgPQgDgPgKgJQgKgIgTgBQgTAAgLAIg");
	this.shape.setTransform(-452.35,-181.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("");
	this.shape_1.setTransform(-87.825,-179.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("AggBnQgYgLgNgYQgMgZAAgrQAAgqAMgZQANgYAYgLQAYgKAhABQAQAAAOACIAZAFIAAAwQgLgDgMgCQgLgDgOAAQgTAAgMAGQgLAGgGAOQgGAOAAAYQAAAZAGAOQAGAOALAFQANAGATAAQANAAAMgCQANgCALgEIAAAvIgQAFIgUADIgVABIgDAAQgfAAgXgJg");
	this.shape_2.setTransform(276.225,-178.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape},{t:this.shape_1}]},9).to({state:[{t:this.shape},{t:this.shape_1},{t:this.shape_2}]},10).wait(10));

	// 图层_5
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AghBoQgXgKgOgZQgMgZAAgsQAAgrAMgZQAOgZAXgKQAZgKAhAAQARABAOABQAQACAJADIAAAxQgLgEgLgBQgNgCgNAAQgTgBgNAGQgLAGgGAOQgGAOAAAZQAAAZAGAOQAGAOALAGQANAGAUAAQANAAANgCQAMgCALgEIAAAwIgPAEIgVADIgWABIgDABQgfAAgYgKg");
	this.shape_3.setTransform(258.9,-93.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgOCYQgOgEgHgIQgIgIgFgLIgDAfIg2AAIAAkzIA7AAIAABzQAGgMAQgJQAPgJAcAAQAjAAATAOQATAOAHAZQAIAZgBAjQABAggIAZQgHAagTAPQgTAPgjAAQgUAAgNgEgAgegSQgLAIgEAPQgFAPAAAXQAAAVAFAPQAEAQALAIQALAJATAAQAUgBAKgJQAKgJADgQQADgPAAgTQAAgVgDgPQgDgPgKgJQgKgJgUAAQgTAAgLAIg");
	this.shape_4.setTransform(-160.4734,-97.575);

	this.instance = new lib.元件1("single",2);
	this.instance.setTransform(441.4,14.4,1.2688,1.2688,0,0,0,121.8,94.7);

	this.instance_1 = new lib.元件1("single",1);
	this.instance_1.setTransform(23.2,14.4,1.2688,1.2688,0,0,0,121.8,94.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("");
	this.shape_5.setTransform(-581.625,-93.4);

	this.instance_2 = new lib.元件1("single",0);
	this.instance_2.setTransform(-395,14.35,1.2688,1.2688,0,0,0,121.8,94.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.shape_5},{t:this.instance_1},{t:this.instance},{t:this.shape_4},{t:this.shape_3}]}).wait(30));

	// 图层_1
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("");
	this.shape_6.setTransform(49.9505,-173.425);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#E89994").ss(4,1,1).p("AirjvIFXAAQBEAAAABEIAAFXQAABEhEAAIlXAAQhEAAAAhEIAAlXQAAhEBEAAg");
	this.shape_7.setTransform(-88.75,-178.5112,1,1.0011);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AirDwQhEAAAAhEIAAlXQAAhEBEAAIFXAAQBEAAAABEIAAFXQAABEhEAAg");
	this.shape_8.setTransform(-88.75,-178.5112,1,1.0011);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FAEBEA").s().p("AuhFDIAAqFIdDAAIAAKFg");
	this.shape_9.setTransform(43.1343,-178.525,1.2217,1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#F29435").ss(4,1,1).p("AirjvIFXAAQBEAAAABEIAAFXQAABEhEAAIlXAAQhEAAAAhEIAAlXQAAhEBEAAg");
	this.shape_10.setTransform(275.35,-178.5112,1,1.0011);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AirDwQhEAAAAhEIAAlXQAAhEBEAAIFXAAQBEAAAABEIAAFXQAABEhEAAg");
	this.shape_11.setTransform(275.35,-178.5112,1,1.0011);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FDEBD8").s().p("AuhFDIAAqFIdDAAIAAKFg");
	this.shape_12.setTransform(407.2343,-178.525,1.2217,1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#46B15B").ss(4,1,1).p("AirjvIFXAAQBEAAAABEIAAFXQAABEhEAAIlXAAQhEAAAAhEIAAlXQAAhEBEAAg");
	this.shape_13.setTransform(-452.9,-178.5112,1,1.0011);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AirDwQhEAAAAhEIAAlXQAAhEBEAAIFXAAQBEAAAABEIAAFXQAABEhEAAg");
	this.shape_14.setTransform(-452.9,-178.5112,1,1.0011);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#E3F0DF").s().p("AuhFDIAAqFIdDAAIAAKFg");
	this.shape_15.setTransform(-321.0235,-178.525,1.2217,1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]}).wait(30));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(-596,-278.2,1195.6,416.8);
p.frameBounds = [rect, rect=new cjs.Rectangle(-596,-215.8,1195.6,354.5), rect, rect, rect, rect, rect, rect, rect, rect, rect=new cjs.Rectangle(-596,-218,1195.6,356.7), rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(447.5,57.52);
	...
	this.shape_1.setTransform(432.475,54.65);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#231F20").s().p("");
	this.shape_2.setTransform(412.1,51.25);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#231F20").s().p("");
	this.shape_3.setTransform(394.45,51.2759);
	...
	this.shape_4.setTransform(366.8231,47.875);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#231F20").s().p("AAhBbIAAhsQABgSgGgIQgHgIgRAAQgNAAgKAGQgKAFgEAOIAAB1IgvAAIAAixIAvAAIAAAVQAIgNAOgGQAOgGATAAQAWAAANAHQANAHAGANQAFANABAUIAAB5g");
	this.shape_5.setTransform(346.25,51.175);
	...
	this.shape_6.setTransform(324.9,51.25);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#231F20").s().p("AAhB9IAAhtQABgRgHgIQgFgIgRABQgPgBgJAGQgKAGgDANIAAB1IgxAAIAAj5IAxAAIAABeQAHgNAOgGQAOgGAUAAQAVAAANAHQANAGAGAOQAGANgBASIAAB6g");
	this.shape_7.setTransform(296.35,47.725);
	...
	this.shape_8.setTransform(277.625,51.3251);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#231F20").s().p("AgGBqQgMgFgGgNQgGgNAAgXIAAhSIgXAAIAAgmIAXAAIAAgqIAvAAIAAAqIAlAAIAAAmIglAAIAABOQgBAPAFAGQAEAFANAAIAHAAIAGgBIAAAlIgLABIgLAAIgEAAQgTAAgMgFg");
	this.shape_9.setTransform(263.45,49.3271);
	...
	this.shape_10.setTransform(246.8,51.25);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#231F20").s().p("ABUBbIAAhsQABgSgGgIQgHgIgPAAQgOAAgIAGQgJAGgDAOIAAB0IgvAAIAAhsQABgSgHgIQgGgIgOAAQgOAAgIAGQgIAFgDANIAAB2IgwAAIAAixIAwAAIAAAUQAHgMAMgGQAMgGATAAQAUAAANAHQALAGAGAMQAIgNANgGQAPgGAUAAQAeAAAPAPQAOAQAAAhIAAB1g");
	this.shape_11.setTransform(221.7,51.1742);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#231F20").s().p("AglAxQAIgOAHgRQAGgSAEgQQAFgRAAgPIAtAAQAAALgEANQgDANgFANIgMAaQgHAMgGAJg");
	this.shape_12.setTransform(191.475,59.85);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#231F20").s().p("AAhBbIAAhsQABgSgGgIQgGgIgRAAQgPAAgJAGQgKAFgDAOIAAB1IgxAAIAAixIAxAAIAAAVQAHgNAOgGQAOgGAUAAQAVAAANAHQANAHAGANQAGANgBAUIAAB5g");
	this.shape_13.setTransform(176.3,51.175);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#231F20").s().p("AgpBVQgUgIgKgVQgKgUAAgkQAAgjAKgUQAKgUAUgIQAUgJAbABQAeAAARAKQARAKAGARQAGASAAAXIgBANIgBALIhyAHQACATALAJQAMAJAXAAQALAAALgCQAMgCAJgDQAKgCAGgEIAAAmQgJAFgSAEQgSADgYAAIgDAAQgYAAgSgHgAgYgtQgJAJgBAWIBIgGQABgKgDgIQgCgIgHgEQgHgFgOAAQgVAAgJAKg");
	this.shape_14.setTransform(156.1018,51.3251);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#231F20").s().p("AgFBqQgNgFgGgNQgGgNAAgXIAAhSIgXAAIAAgmIAXAAIAAgqIAvAAIAAAqIAlAAIAAAmIglAAIAABOQAAAPAEAGQAFAFAMAAIAHAAIAGgBIAAAlIgLABIgLAAIgEAAQgTAAgLgFg");
	this.shape_15.setTransform(140.5,49.3271);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#231F20").s().p("");
	this.shape_16.setTransform(126.6,51.2759);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#231F20").s().p("AgXB/IAAixIAvAAIAACxgAgPhNQgGgBgDgGQgCgFAAgMQAAgLACgFQADgFAGgCQAFgCAKABQALgBAGACQAFACADAFQACAFAAALQAAAMgCAFQgDAGgFABQgGACgLAAQgKAAgFgCg");
	this.shape_17.setTransform(113.775,47.595);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#231F20").s().p("AhGByIAAjkIAzAAIAAC5IBaAAIAAArg");
	this.shape_18.setTransform(101.3,48.8);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgXCXQgbgHgTgRQgUgSgLgfQgKgeAAgwQABg5ARgjQASgjAhgOQAigPArAAQAWAAASADQASACAOAFIAAA6QgOgFgRgDQgRgDgTAAQgbAAgRAJQgSAKgIAWQgJAVAAAlQAAAnAJAWQAIAVASAJQAQAIAbAAQATAAARgDQASgDARgGIAAA5QgOAGgTAEQgTADgWAAQghAAgbgGg");
	this.shape_19.setTransform(44,47.175);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#0D8075").s().p("AirCsQhHhHAAhlQAAhkBHhIQBHhGBkAAQBlAABHBGQBHBIAABkQAABlhHBHQhHBHhlAAQhkAAhHhHg");
	this.shape_20.setTransform(46.725,47.675);
	...
	this._showbar.setTransform(642,329.4,0.9556,0.9556,0,0,0,25.2,-26.2);
	...
	this.shape_21.graphics.f("rgba(255,255,255,0.8)").s().p("EhkVAEsIAApXMDIrAAAIAAJXg");
	this.shape_21.setTransform(639.9,690.4);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1734079457859", id:"index_atlas_1"}
	],
	preloads: []
};
