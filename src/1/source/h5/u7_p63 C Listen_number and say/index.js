...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,489,636,469],[638,489,636,460],[648,0,649,446],[0,0,646,487]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// 图层_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("AAFCLIAAjgIhDANIAAgxIBSgRIArAAIAAEVg");
	this.shape.setTransform(-219.925,-39.725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("AhgCNIAAg0QAxgnAbgaQAbgZAMgSQAMgSAAgPQgBgXgNgIQgMgJgWAAQgNAAgQADQgPACgSAGIAAgxQAQgFASgCQAUgDATAAQAuAAAZAUQAZATABAoQAAARgEAOQgFAPgJAPQgLAPgUASQgTATgdAYIgRAOIAAADIB4AAIAAAwg");
	this.shape_1.setTransform(250.2,247.725);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("");
	this.shape_2.setTransform(250.15,-37.0266);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FF0000").s().p("AATCLIAAg7Ih7AAIAAg5IBvihIBDAAIAACoIAfAAIAAAyIgfAAIAAA7gAg3AcIAAACIBKAAIAAhsIgDAAg");
	this.shape_3.setTransform(-218.575,247.925);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape},{t:this.shape_1}]},9).to({state:[{t:this.shape},{t:this.shape_2},{t:this.shape_1}]},10).to({state:[{t:this.shape},{t:this.shape_2},{t:this.shape_3},{t:this.shape_1}]},10).wait(10));

	// 图层_1
	this.instance = new lib.位图3();
	this.instance.setTransform(59,-290,0.6149,0.6149);

	this.instance_1 = new lib.位图2();
	this.instance_1.setTransform(-415,-301,0.6213,0.6213);

	this.instance_2 = new lib.位图5();
	this.instance_2.setTransform(58,-16,0.615,0.615);

	this.instance_3 = new lib.位图4();
	this.instance_3.setTransform(-423,0,0.6213,0.6213);
...
p.nominalBounds = rect = new cjs.Rectangle(-423,-301,878.3,584.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		var _this = this;
		var showNum = 0;
		var timeArr = new Array(0,5.852,15.442,25.696);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(473.45,57.52);
	...
	this.shape_1.setTransform(458.425,54.65);
	...
	this.shape_2.setTransform(438.05,51.25);
	...
	this.shape_3.setTransform(420.4,51.2759);
	...
	this.shape_4.setTransform(392.7731,47.875);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#231F20").s().p("AAiBbIAAhsQAAgSgGgIQgHgIgQAAQgPAAgJAGQgJAFgFAOIAAB1IgwAAIAAixIAwAAIAAAVQAIgNAPgGQANgGAUAAQAVAAANAHQANAHAGANQAFANAAAUIAAB5g");
	this.shape_5.setTransform(372.2,51.175);
	...
	this.shape_6.setTransform(350.85,51.25);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#231F20").s().p("AgzBbIAAixIAwAAIAAAgQAFgPAIgIQAIgHAKgDQAJgDALAAIAEAAIgCArIgEAAQgMAAgKADQgKADgIAJQgGAIgDAOIAABlg");
	this.shape_7.setTransform(327.075,51.175);
	...
	this.shape_8.setTransform(309.8518,51.3251);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#231F20").s().p("AgLB7QgLgDgHgGQgGgHgDgIIgEAZIgrAAIAAj6IAwAAIAABeQAFgKANgHQAMgHAWgBQAdAAAQAMQAPALAGAVQAGATgBAdQABAagGAUQgGAVgPAMQgQANgdAAQgPAAgLgEgAgYgOQgJAGgEAMQgDANAAASQAAARADAMQAEANAJAHQAJAHAPAAQARAAAIgIQAIgIACgMQADgNAAgPQAAgRgDgNQgDgLgIgIQgIgHgQAAQgPAAgJAHg");
	this.shape_9.setTransform(290.0269,47.875);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#231F20").s().p("ABUBbIAAhsQAAgSgFgIQgHgIgPAAQgOAAgJAGQgHAGgEAOIAAB0IguAAIAAhsQgBgSgFgIQgHgIgOAAQgPAAgHAGQgIAFgDANIAAB2IgwAAIAAixIAwAAIAAAUQAHgMAMgGQAMgGATAAQAUAAAMAHQAMAGAGAMQAHgNAPgGQAOgGATAAQAfAAAOAPQAPAQAAAhIAAB1g");
	this.shape_10.setTransform(263.5,51.1742);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#231F20").s().p("AgUBaQgWAAgNgGQgNgHgGgNQgGgNAAgUIAAh5IAwAAIAABsQAAASAGAIQAGAIARAAQANAAAKgGQAJgFAEgOIAAh1IAwAAIAACxIgrAAIgEgVQgHANgOAGQgNAGgRAAIgDgBg");
	this.shape_11.setTransform(237.425,51.5019);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#231F20").s().p("AAhBbIAAhsQABgSgGgIQgHgIgRAAQgNAAgKAGQgKAFgDAOIAAB1IgwAAIAAixIAwAAIAAAVQAHgNAOgGQAOgGATAAQAWAAANAHQANAHAGANQAFANABAUIAAB5g");
	this.shape_12.setTransform(216.65,51.175);
