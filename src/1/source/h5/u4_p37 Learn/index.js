...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,0,474,220]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// 图层_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("A7ID5IAAnxMA2RAAAIAAHxg");
	this.shape.setTransform(173.675,24.9);
...
p.nominalBounds = rect = null;
p.frameBounds = [rect, rect, rect, new cjs.Rectangle(0,0,347.4,49.8)];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-222.85,17.2,0.8493,1,0,0,0,173.6,24.9);
	...
	// 图层_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("");
	this.shape.setTransform(-271.675,15.1763);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(-223.1208,15.175);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("");
	this.shape_2.setTransform(-223.1208,15.1763);
...
p.nominalBounds = rect = new cjs.Rectangle(-370.3,-15.3,295,58.3);
p.frameBounds = [rect, new cjs.Rectangle(-360.7,1.7,275.2,27)];
...
if (reversed == null) { reversed = false; }
	...
	// 图层_2
	this.instance = new lib.元件1();
	this.instance.setTransform(-74,-0.65,1,1,0,0,0,173.7,24.9);
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.元件1(), 3);
	...
	// 图层_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(-44.125,5.2737);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("");
	this.shape_1.setTransform(-74.675,-1.7237);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("");
	this.shape_2.setTransform(-74.675,1.6);
...
p.nominalBounds = rect = new cjs.Rectangle(-247.7,-32.2,492.7,58.3);
p.frameBounds = [rect, new cjs.Rectangle(-237.2,-15.2,325,33.6)];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(727,259,0.7279,0.7274);
	...
	this.mc2.name = "mc2";
	this.mc2.setTransform(628.3,356.05);

	this.mc1 = new lib.元件17();
	this.mc1.name = "mc1";
	this.mc1.setTransform(502.5,301.25);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FAEBEC").s().p("EhXkAeZQhvAAhOhCQhOhCAAhdMAAAg1vQAAhdBOhCQBOhCBvAAMCvJAAAQBvAABOBCQBOBCAABdMAAAA1vQAABdhOBCQhOBChvAAg");
	this.shape.setTransform(640.025,360.025);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.pro_bar},{t:this.mc1},{t:this.mc2}]}).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1733364168502", id:"index_atlas_1"}
	],
	preloads: []
};
